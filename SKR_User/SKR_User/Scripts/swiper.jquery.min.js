...
function() {
    ...
    var a, t = function(e, s) {
        ...
        function d(e) {
            ...
            else if ("mousewheel" === a) if (y.params.mousewheelForceToAxis) if (r()) {
            ...
            else if ("wheel" === a) if (y.params.mousewheelForceToAxis) if (r()) {
        ...
        for (var w in m) if ("undefined" == typeof s[w]) s[w] = m[w];
        else if ("object" == typeof s[w]) for (var b in m[w])"undefined" == typeof s[w][b] && (s[w][b] = m[w][b]);
        var y = this;
        ...
        y.params.breakpoints && y.setBreakpoint(), y.container = a(e), 0 !== y.container.length)) {
            ...
            ["cube", "coverflow"].indexOf(y.params.effect) >= 0 && (y.support.transforms3d ? (y.params.watchSlidesProgress = !0, y.classNames.push("swiper-container-3d")) : y.params.effect = "slide"),
            ...
            "fade" === y.params.effect && (y.params.slidesPerView = 1, y.params.slidesPerColumn = 1, y.params.slidesPerGroup = 1, y.params.watchSlidesProgress = !0, y.params.spaceBetween = 0, "undefined" == typeof f && (y.params.virtualTranslate = !0)),
            y.params.grabCursor && y.support.touch && (y.params.grabCursor = !1),
            y.wrapper = y.container.children("." + y.params.wrapperClass),
            y.params.pagination && (y.paginationContainer = a(y.params.pagination), y.params.paginationClickable && y.paginationContainer.addClass("swiper-pagination-clickable")),
            y.rtl = r() && ("rtl" === y.container[0].dir.toLowerCase() || "rtl" === y.container.css("direction")),
            ...
            y.updateContainerSize = function() {
                ...
                0 === e && r() || 0 === a && !r() || (e = e - parseInt(y.container.css("padding-left"), 10) - parseInt(y.container.css("padding-right"), 10), a = a - parseInt(y.container.css("padding-top"), 10) - parseInt(y.container.css("padding-bottom"), 10), y.width = e, y.height = a, y.size = r() ? y.width: y.height)
            },
            y.updateSlidesSize = function() {
                ...
                })), y.params.slidesPerColumn > 1 && (y.virtualSize = (l + y.params.spaceBetween) * o, y.virtualSize = Math.ceil(y.virtualSize / y.params.slidesPerColumn) - y.params.spaceBetween, y.wrapper.css({
                    width: y.virtualSize + y.params.spaceBetween + "px"
                ...
                0 !== y.params.spaceBetween && (r() ? y.rtl ? y.slides.css({
                    marginLeft: a + "px"
                }) : y.slides.css({
                    marginRight: a + "px"
                }) : y.slides.css({
            ...
            y.updateClasses = function() {
                ...
                if (e.addClass(y.params.slideActiveClass), e.next("." + y.params.slideClass).addClass(y.params.slideNextClass), e.prev("." + y.params.slideClass).addClass(y.params.slidePrevClass), y.bullets && y.bullets.length > 0) {
                    ...
                    var t;
                    y.params.loop ? (t = Math.ceil(y.activeIndex - y.loopedSlides) / y.params.slidesPerGroup, t > y.slides.length - 1 - 2 * y.loopedSlides && (t -= y.slides.length - 2 * y.loopedSlides), t > y.bullets.length - 1 && (t -= y.bullets.length)) : t = "undefined" != typeof y.snapIndex ? y.snapIndex: y.activeIndex || 0,
            ...
            y.updatePagination = function() {
                if (y.params.pagination && y.paginationContainer && y.paginationContainer.length > 0) {
                    for (var e = "",
                    a = y.params.loop ? Math.ceil((y.slides.length - 2 * y.loopedSlides) / y.params.slidesPerGroup) : y.snapGrid.length, t = 0; a > t; t++) e += y.params.paginationBulletRender ? y.params.paginationBulletRender(t, y.params.bulletClass) : "<" + y.params.paginationElement + ' class="' + y.params.bulletClass + '"></' + y.params.paginationElement + ">";
            ...
            y.initEvents = function(e) {
                ...
                y.browser.ie ? (i[r](y.touchEvents.start, y.onTouchStart, !1), n[r](y.touchEvents.move, y.onTouchMove, o), n[r](y.touchEvents.end, y.onTouchEnd, !1)) : (y.support.touch && (i[r](y.touchEvents.start, y.onTouchStart, !1), i[r](y.touchEvents.move, y.onTouchMove, o), i[r](y.touchEvents.end, y.onTouchEnd, !1)), !s.simulateTouch || y.device.ios || y.device.android || (i[r]("mousedown", y.onTouchStart, !1), document[r]("mousemove", y.onTouchMove, o), document[r]("mouseup", y.onTouchEnd, !1))),
                window[r]("resize", y.onResize),
                y.params.nextButton && (a(y.params.nextButton)[t]("click", y.onClickNext), y.params.a11y && y.a11y && a(y.params.nextButton)[t]("keydown", y.a11y.onEnterKey)),
                y.params.prevButton && (a(y.params.prevButton)[t]("click", y.onClickPrev), y.params.a11y && y.a11y && a(y.params.prevButton)[t]("keydown", y.a11y.onEnterKey)),
                y.params.pagination && y.params.paginationClickable && (a(y.paginationContainer)[t]("click", "." + y.params.bulletClass, y.onClickIndex), y.params.a11y && y.a11y && a(y.paginationContainer)[t]("keydown", "." + y.params.bulletClass, y.a11y.onEnterKey)),
                (y.params.preventClicks || y.params.preventClicksPropagation) && i[r]("click", y.preventClicks, !0)
            },
            ...
            y.updateClickedSlide = function(e) {
                ...
                if (y.clickedSlide = t, y.clickedIndex = a(t).index(), y.params.slideToClickedSlide && void 0 !== y.clickedIndex && y.clickedIndex !== y.activeIndex) {
                    ...
                    if (y.params.loop) {
                        ...
                        y.params.centeredSlides ? n < y.loopedSlides - y.params.slidesPerView / 2 || n > y.slides.length - y.loopedSlides + y.params.slidesPerView / 2 ? (y.fixLoop(), n = y.wrapper.children("." + y.params.slideClass + '[data-swiper-slide-index="' + i + '"]:not(.swiper-slide-duplicate)').eq(0).index(), setTimeout(function() {
                            y.slideTo(n)
                        },
            ...
            y.onTouchMove = function(e) {
                if (e.originalEvent && (e = e.originalEvent), !(A && "mousemove" === e.type || e.preventedByNestedSwiper)) {
                    ...
                    void(T && (y.touches.startX = y.touches.currentX = "touchmove" === e.type ? e.targetTouches[0].pageX: e.pageX, y.touches.startY = y.touches.currentY = "touchmove" === e.type ? e.targetTouches[0].pageY: e.pageY, M = Date.now()));
                    if (A && document.activeElement && e.target === document.activeElement && a(e.target).is(L)) return S = !0,
                    void(y.allowClick = !1);
                            ...
                            if (O || !y.browser.ieTouch) {
                                ...
                                if (i > 0 && I > y.minTranslate() ? (n = !1, y.params.resistance && (I = y.minTranslate() - 1 + Math.pow( - y.minTranslate() + k + i, y.params.resistanceRatio))) : 0 > i && I < y.maxTranslate() && (n = !1, y.params.resistance && (I = y.maxTranslate() + 1 - Math.pow(y.maxTranslate() - k - i, y.params.resistanceRatio))), n && (e.preventedByNestedSwiper = !0), !y.params.allowSwipeToNext && "next" === y.swipeDirection && k > I && (I = k), !y.params.allowSwipeToPrev && "prev" === y.swipeDirection && I > k && (I = k), y.params.followFinger) {
                                    if (y.params.threshold > 0) {
                                        ...
                                        I = k,
                                        void(y.touches.diff = r() ? y.touches.currentX - y.touches.startX: y.touches.currentY - y.touches.startY)
                ...
                if (e.originalEvent && (e = e.originalEvent), C && y.emit("onTouchEnd", y, e), C = !1, T) {
                    ...
                    if (r = y.params.followFinger ? y.rtl ? y.translate: -y.translate: -I, y.params.freeMode) {
                        ...
                        if (y.params.freeModeMomentum) {
                            ...
                            if (u < y.maxTranslate()) y.params.freeModeMomentumBounce ? (u + y.maxTranslate() < -f && (u = y.maxTranslate() - f), c = y.maxTranslate(), m = !0, D = !0) : u = y.maxTranslate();
                            else if (u > y.minTranslate()) y.params.freeModeMomentumBounce ? (u - y.minTranslate() > f && (u = y.minTranslate() + f), c = y.minTranslate(), m = !0, D = !0) : u = y.minTranslate();
                                ...
                                u = Math.abs(y.snapGrid[h] - u) < Math.abs(y.snapGrid[h - 1] - u) || "next" === y.swipeDirection ? y.snapGrid[h] : y.snapGrid[h - 1],
                                y.rtl || (u = -u)
                            }
            ...
            y.setWrapperTranslate = function(e, a, t) {
                ...
                o = 0;
                r() ? s = y.rtl ? -e: e: n = e,
                y.params.roundLengths && (s = i(s), n = i(n)),
                ...
                l = 0 === p ? 0 : (e - y.minTranslate()) / p,
                l !== y.progress && y.updateProgress(e),
            ...
            y.effects = {
                ...
                cube: {
                    setTranslate: function() {
                        var e, t = 0;
                        y.params.cube.shadow && (r() ? (e = y.wrapper.find(".swiper-cube-shadow"), 0 === e.length && (e = a('<div class="swiper-cube-shadow"></div>'), y.wrapper.append(e)), e.css({
                            height: y.width + "px"
                        ...
                        for (var s = 0; s < y.slides.length; s++) {
                            ...
                            d = 0,
                            u = 0;
                            s % 4 === 0 ? (p = 4 * -o * y.size, u = 0) : (s - 1) % 4 === 0 ? (p = 0, u = 4 * -o * y.size) : (s - 2) % 4 === 0 ? (p = y.size + 4 * o * y.size, u = y.size) : (s - 3) % 4 === 0 && (p = -y.size, u = 3 * y.size + 4 * y.size * o),
                            y.rtl && (p = -p),
                            r() || (d = p, p = 0);
                        ...
                        }), y.params.cube.shadow) if (r()) e.transform("translate3d(0px, " + (y.width / 2 + y.params.cube.shadowOffset) + "px, " + -y.width / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + y.params.cube.shadowScale + ")");
                        else {
                    ...
                    setTransition: function(e) {
                        ...
                        y.params.cube.shadow && !r() && y.container.find(".swiper-cube-shadow").transition(e)
                    }
                },
                coverflow: {
                    setTranslate: function() {
                        for (var e = y.translate,
                        t = r() ? -e + y.width / 2 : -e + y.height / 2, s = r() ? y.params.coverflow.rotate: -y.params.coverflow.rotate, i = y.params.coverflow.depth, n = 0, o = y.slides.length; o > n; n++) {
                            var l = y.slides.eq(n),
            ...
            y.scrollbar = {
                ...
                setTranslate: function() {
                    if (y.params.scrollbar) {
                        ...
                        y.rtl && r() ? (e = -e, e > 0 ? (t = a.dragSize - e, e = 0) : -e + a.dragSize > a.trackSize && (t = a.trackSize + e)) : 0 > e ? (t = a.dragSize + e, e = 0) : e + a.dragSize > a.trackSize && (t = a.trackSize - e),
                        r() ? (y.support.transforms3d ? a.drag.transform("translate3d(" + e + "px, 0, 0)") : a.drag.transform("translateX(" + e + "px)"), a.drag[0].style.width = t + "px") : (y.support.transforms3d ? a.drag.transform("translate3d(0px, " + e + "px, 0)") : a.drag.transform("translateY(" + e + "px)"), a.drag[0].style.height = t + "px"),
            ...
            y.off = function(e, a) {
                var t;
                if (e = c(e), "undefined" == typeof a) return y.emitterEventListeners[e] = [],
                y;
            ...
            y.a11y = {
                ...
                init: function() {
                    ...
                    if (y.params.prevButton) {
                        ...
                        y.a11y.addLabel(t, y.params.prevSlideMessage)
                    }
